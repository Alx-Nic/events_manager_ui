<template>
  <v-card min-width="280px" max-width="400px">
    ...
    <v-card-actions>
      <v-btn small color="primary" @click.prevent="createInviteCode"
        >Invite link</v-btn
      >
      <v-btn small text color="secondary">View user</v-btn>
      <v-btn small text color="secondary">View Occasions</v-btn>
    </v-card-actions>
